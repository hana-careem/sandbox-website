          ...
          <ul className="flex flex-col p-3">
            <li>
              <Link
                ...
                className={
                  ...
                  (pathname === '/' ? 'bg-white/5 text-white' : 'text-white/70')
                }
              >
                Home
              </Link>
              ...
              >
                <div className="pl-4 py-1 flex flex-col gap-1 border-l border-white/10 ml-6 mt-1 mb-2">
                  <Link
                    href="/about"
                    onClick={() => setMenuOpen(false)}
                    className="block px-4 py-2.5 text-sm font-medium text-white/50 rounded-xl transition-colors"
                  >
                    Overview
                  </Link>
                  <Link
            ...
            <li>
              <Link
                ...
                className={
                  'block rounded-2xl px-4 py-3 text-base transition-colors ' +
                  (pathname === '/what-we-offer' ? 'bg-white/5 text-white' : 'text-white/70')
                }
              >
                What We Offer
              </Link>
